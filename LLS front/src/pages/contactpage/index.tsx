...
const Contactform = () => {
    ...
    <div className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-white font-[sans-serif]">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500 mt-4 text-justify">We’re here to help answer your questions. Judicial matters can be complicated, our experts are on hand to help inform you of every aspect regarding your topic. We take great pride in using our expertise for you and look forward to hearing from you.</p>
                    ...
                    <ul className="mt-4">
                        <li className="flex items-center">
                            <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0 animate-bounce">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#C62828'
                            ...
                            <a href="javascript:void(0)" className="text-red-800 text-sm ml-4">
                ...
                <div className="mt-12">
                    ...
                    <ul className="flex mt-4 space-x-4">
                        <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0 animate-bounce">
